 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return DuoAccount*/
func (a *DuoApiService) DuoAccountDelete(ctx context.Context, id string, localVarOptionals map[string]interface{}) (DuoAccount,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return DuoAccount*/
func (a *DuoApiService) DuoAccountGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (DuoAccount,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return []DuoAccount*/
func (a *DuoApiService) DuoAccountList(ctx context.Context, localVarOptionals map[string]interface{}) ([]DuoAccount,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return DuoAccount*/
func (a *DuoApiService) DuoAccountPost(ctx context.Context, localVarOptionals map[string]interface{}) (DuoAccount,  *http.Response, error) {
	var (
...
func (a *DuoApiService) DuoApplicationDelete(ctx context.Context, accountId string, applicationId string, localVarOptionals map[string]interface{}) (DuoApplication,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return DuoApplication*/
func (a *DuoApiService) DuoApplicationGet(ctx context.Context, accountId string, applicationId string, localVarOptionals map[string]interface{}) (DuoApplication,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return []DuoApplication*/
func (a *DuoApiService) DuoApplicationList(ctx context.Context, accountId string, localVarOptionals map[string]interface{}) ([]DuoApplication,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return DuoApplication*/
func (a *DuoApiService) DuoApplicationPost(ctx context.Context, accountId string, localVarOptionals map[string]interface{}) (DuoApplication,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return DuoApplication*/
func (a *DuoApiService) DuoApplicationUpdate(ctx context.Context, accountId string, applicationId string, localVarOptionals map[string]interface{}) (DuoApplication,  *http.Response, error) {
	var (
