...
func (a *GSuiteApiService) GraphGSuiteAssociationsList(ctx context.Context, gsuiteId string, targets []string, localVarOptionals map[string]interface{}) ([]GraphConnection,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param gsuiteId ObjectID of the G Suite instance.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "body" (GraphOperationGSuite) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return */
func (a *GSuiteApiService) GraphGSuiteAssociationsPost(ctx context.Context, gsuiteId string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(GraphOperationGSuite); localVarOk {
...
func (a *GSuiteApiService) GraphGSuiteTraverseUser(ctx context.Context, gsuiteId string, localVarOptionals map[string]interface{}) ([]GraphObjectWithPaths,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "filter" ([]string) A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
 @return []GraphObjectWithPaths*/
func (a *GSuiteApiService) GraphGSuiteTraverseUserGroup(ctx context.Context, gsuiteId string, localVarOptionals map[string]interface{}) ([]GraphObjectWithPaths,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return Gsuite*/
func (a *GSuiteApiService) GsuitesGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (Gsuite,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  Gsuite
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param gsuiteId 
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "maxResults" (int32) Google Directory API maximum number of results per page. See https://developers.google.com/admin-sdk/directory/reference/rest/v1/users/list.
     @param "orderBy" (string) Google Directory API sort field parameter. See https://developers.google.com/admin-sdk/directory/reference/rest/v1/users/list.
     @param "pageToken" (string) Google Directory API token used to access the next page of results. See https://developers.google.com/admin-sdk/directory/reference/rest/v1/users/list.
     @param "query" (string) Google Directory API search parameter. See https://developers.google.com/admin-sdk/directory/v1/guides/search-users.
     @param "sortOrder" (string) Google Directory API sort direction parameter. See https://developers.google.com/admin-sdk/directory/reference/rest/v1/users/list.
 @return InlineResponse2001*/
func (a *GSuiteApiService) GsuitesListImportJumpcloudUsers(ctx context.Context, gsuiteId string, localVarOptionals map[string]interface{}) (InlineResponse2001,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
	...
	if err := typeCheckParameter(localVarOptionals["maxResults"], "int32", "maxResults"); err != nil {
		return successPayload, nil, err
	}
	...
	if localVarTempParam, localVarOk := localVarOptionals["maxResults"].(int32); localVarOk {
		localVarQueryParams.Add("maxResults", parameterToString(localVarTempParam, ""))
	}
...
func (a *GSuiteApiService) GsuitesListImportUsers(ctx context.Context, gsuiteId string, localVarOptionals map[string]interface{}) (InlineResponse2002,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return Gsuite*/
func (a *GSuiteApiService) GsuitesPatch(ctx context.Context, id string, localVarOptionals map[string]interface{}) (Gsuite,  *http.Response, error) {
	var (
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(Gsuite); localVarOk {
		localVarPostBody = &localVarTempParam
	}
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return []GSuiteTranslationRule*/
func (a *GSuiteApiService) TranslationRulesGSuiteList(ctx context.Context, gsuiteId string, localVarOptionals map[string]interface{}) ([]GSuiteTranslationRule,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return GSuiteTranslationRule*/
func (a *GSuiteApiService) TranslationRulesGSuitePost(ctx context.Context, gsuiteId string, localVarOptionals map[string]interface{}) (GSuiteTranslationRule,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
