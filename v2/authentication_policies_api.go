 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return AuthnPolicy*/
func (a *AuthenticationPoliciesApiService) AuthnpoliciesDelete(ctx context.Context, id string, localVarOptionals map[string]interface{}) (AuthnPolicy,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  AuthnPolicy
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return AuthnPolicy*/
func (a *AuthenticationPoliciesApiService) AuthnpoliciesGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (AuthnPolicy,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return []AuthnPolicy*/
func (a *AuthenticationPoliciesApiService) AuthnpoliciesList(ctx context.Context, localVarOptionals map[string]interface{}) ([]AuthnPolicy,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
     @param "body" (AuthnPolicy) 
 @return AuthnPolicy*/
func (a *AuthenticationPoliciesApiService) AuthnpoliciesPatch(ctx context.Context, id string, localVarOptionals map[string]interface{}) (AuthnPolicy,  *http.Response, error) {
	var (
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(AuthnPolicy); localVarOk {
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "body" (AuthnPolicy) 
 @return AuthnPolicy*/
func (a *AuthenticationPoliciesApiService) AuthnpoliciesPost(ctx context.Context, localVarOptionals map[string]interface{}) (AuthnPolicy,  *http.Response, error) {
	var (
