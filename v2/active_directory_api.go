 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
func (a *ActiveDirectoryApiService) ActivedirectoriesAgentsDelete(ctx context.Context, activedirectoryId string, agentId string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
...
func (a *ActiveDirectoryApiService) ActivedirectoriesAgentsGet(ctx context.Context, activedirectoryId string, agentId string, localVarOptionals map[string]interface{}) (ActiveDirectoryAgentList,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  ActiveDirectoryAgentList
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return []ActiveDirectoryAgentList*/
func (a *ActiveDirectoryApiService) ActivedirectoriesAgentsList(ctx context.Context, activedirectoryId string, localVarOptionals map[string]interface{}) ([]ActiveDirectoryAgentList,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param activedirectoryId 
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "body" (ActiveDirectoryAgent) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return ActiveDirectoryAgentGet*/
func (a *ActiveDirectoryApiService) ActivedirectoriesAgentsPost(ctx context.Context, activedirectoryId string, localVarOptionals map[string]interface{}) (ActiveDirectoryAgentGet,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  ActiveDirectoryAgentGet
	)
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(ActiveDirectoryAgent); localVarOk {
...
func (a *ActiveDirectoryApiService) ActivedirectoriesDelete(ctx context.Context, id string, localVarOptionals map[string]interface{}) (ActiveDirectory,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  ActiveDirectory
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return ActiveDirectory*/
func (a *ActiveDirectoryApiService) ActivedirectoriesGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (ActiveDirectory,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return []ActiveDirectory*/
func (a *ActiveDirectoryApiService) ActivedirectoriesList(ctx context.Context, localVarOptionals map[string]interface{}) ([]ActiveDirectory,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "body" (ActiveDirectory) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return ActiveDirectory*/
func (a *ActiveDirectoryApiService) ActivedirectoriesPost(ctx context.Context, localVarOptionals map[string]interface{}) (ActiveDirectory,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(ActiveDirectory); localVarOk {
		localVarPostBody = &localVarTempParam
	}
	if ctx != nil {
		// API Key Authentication
...
func (a *ActiveDirectoryApiService) GraphActiveDirectoryAssociationsList(ctx context.Context, activedirectoryId string, targets []string, localVarOptionals map[string]interface{}) ([]GraphConnection,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param activedirectoryId 
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "body" (GraphOperationActiveDirectory) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return */
func (a *ActiveDirectoryApiService) GraphActiveDirectoryAssociationsPost(ctx context.Context, activedirectoryId string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(GraphOperationActiveDirectory); localVarOk {
		localVarPostBody = &localVarTempParam
	}
	if ctx != nil {
		// API Key Authentication
...
func (a *ActiveDirectoryApiService) GraphActiveDirectoryTraverseUser(ctx context.Context, activedirectoryId string, localVarOptionals map[string]interface{}) ([]GraphObjectWithPaths,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "filter" ([]string) A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
 @return []GraphObjectWithPaths*/
func (a *ActiveDirectoryApiService) GraphActiveDirectoryTraverseUserGroup(ctx context.Context, activedirectoryId string, localVarOptionals map[string]interface{}) ([]GraphObjectWithPaths,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
