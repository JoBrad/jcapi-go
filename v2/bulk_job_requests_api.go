...
/* BulkJobRequestsApiService Bulk Expire Users
 The endpoint allows you to start a bulk job to asynchronously expire users.
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "body" ([]BulkUserExpire) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return JobId*/
func (a *BulkJobRequestsApiService) BulkUserExpires(ctx context.Context, localVarOptionals map[string]interface{}) (JobId,  *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/bulk/user/expires"
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].([]BulkUserExpire); localVarOk {
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
     @param "body" (BulkScheduledStatechangeCreate) 
 @return []ScheduledUserstateResult*/
func (a *BulkJobRequestsApiService) BulkUserStatesCreate(ctx context.Context, localVarOptionals map[string]interface{}) ([]ScheduledUserstateResult,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  []ScheduledUserstateResult
	)
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(BulkScheduledStatechangeCreate); localVarOk {
		localVarPostBody = &localVarTempParam
	}
	if ctx != nil {
		// API Key Authentication
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return */
func (a *BulkJobRequestsApiService) BulkUserStatesDelete(ctx context.Context, id string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
...
/* BulkJobRequestsApiService Get the next scheduled state change for a list of users
...
func (a *BulkJobRequestsApiService) BulkUserStatesGetNextScheduled(ctx context.Context, users []string, localVarOptionals map[string]interface{}) (InlineResponse200,  *http.Response, error) {
	var (
	...
	if len(users) < 0 {
		return successPayload, nil, reportError("users must have at least 0 elements")
	}
	if len(users) > 100 {
		return successPayload, nil, reportError("users must have less than 100 elements")
	}
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "skip" (int32) The offset into the records to return.
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
     @param "userid" (string) The systemuser id to filter by.
 @return []ScheduledUserstateResult*/
func (a *BulkJobRequestsApiService) BulkUserStatesList(ctx context.Context, localVarOptionals map[string]interface{}) ([]ScheduledUserstateResult,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
/* BulkJobRequestsApiService Bulk Unlock Users
 The endpoint allows you to start a bulk job to asynchronously unlock users.
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "body" ([]BulkUserUnlock) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return JobId*/
func (a *BulkJobRequestsApiService) BulkUserUnlocks(ctx context.Context, localVarOptionals map[string]interface{}) (JobId,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/bulk/user/unlocks"
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].([]BulkUserUnlock); localVarOk {
		localVarPostBody = &localVarTempParam
	}
	if ctx != nil {
		// API Key Authentication
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
     @param "creationSource" (string) Defines the creation-source header for gapps, o365 and workdays requests. If the header isn&#39;t sent, the default value is &#x60;jumpcloud:bulk&#x60;, if you send the header with a malformed value you receive a 400 error. 
 @return JobId*/
func (a *BulkJobRequestsApiService) BulkUsersCreate(ctx context.Context, localVarOptionals map[string]interface{}) (JobId,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
	...
	if err := typeCheckParameter(localVarOptionals["creationSource"], "string", "creationSource"); err != nil {
		return successPayload, nil, err
	}
	...
	if localVarTempParam, localVarOk := localVarOptionals["creationSource"].(string); localVarOk {
		localVarHeaderParams["creation-source"] = parameterToString(localVarTempParam, "")
	}
	// body params
...
func (a *BulkJobRequestsApiService) BulkUsersCreateResults(ctx context.Context, jobId string, localVarOptionals map[string]interface{}) ([]JobWorkresult,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return JobId*/
func (a *BulkJobRequestsApiService) BulkUsersUpdate(ctx context.Context, localVarOptionals map[string]interface{}) (JobId,  *http.Response, error) {
	var (
