...
type PolicyGroupTemplatesApiService service


/* PolicyGroupTemplatesApiService Deletes policy group template.
 Deletes a Policy Group Template.
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param providerId 
 @param id 
 @return */
func (a *PolicyGroupTemplatesApiService) PolicyGroupTemplatesDelete(ctx context.Context, providerId string, id string) ( *http.Response, error) {
	var (
...
/* PolicyGroupTemplatesApiService Gets a provider&#39;s policy group template.
 Retrieves a Policy Group Template for this provider.
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param providerId 
 @param id 
 @return PolicyGroupTemplate*/
func (a *PolicyGroupTemplatesApiService) PolicyGroupTemplatesGet(ctx context.Context, providerId string, id string) (PolicyGroupTemplate,  *http.Response, error) {
	var (
...
/* PolicyGroupTemplatesApiService Retrieve a configured policy template by id.
 Retrieves a Configured Policy Templates for this provider and Id.
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param providerId 
 @param id 
 @return ConfiguredPolicyTemplate*/
func (a *PolicyGroupTemplatesApiService) PolicyGroupTemplatesGetConfiguredPolicyTemplate(ctx context.Context, providerId string, id string) (ConfiguredPolicyTemplate,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
/* PolicyGroupTemplatesApiService List a provider&#39;s policy group templates.
...
func (a *PolicyGroupTemplatesApiService) PolicyGroupTemplatesList(ctx context.Context, providerId string, localVarOptionals map[string]interface{}) (PolicyGroupTemplates,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
/* PolicyGroupTemplatesApiService List a provider&#39;s configured policy templates.
...
func (a *PolicyGroupTemplatesApiService) PolicyGroupTemplatesListConfiguredPolicyTemplates(ctx context.Context, providerId string, localVarOptionals map[string]interface{}) (InlineResponse20014,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
/* PolicyGroupTemplatesApiService Gets the list of members from a policy group template.
...
func (a *PolicyGroupTemplatesApiService) PolicyGroupTemplatesListMembers(ctx context.Context, providerId string, id string, localVarOptionals map[string]interface{}) (PolicyGroupTemplateMembers,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
