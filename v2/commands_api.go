 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
func (a *CommandsApiService) CommandsCancelQueuedCommandsByWorkflowInstanceId(ctx context.Context, workflowInstanceId string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "search" (string) The search string to query records
 @return QueuedCommandList*/
func (a *CommandsApiService) CommandsGetQueuedCommandsByWorkflow(ctx context.Context, localVarOptionals map[string]interface{}) (QueuedCommandList,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  QueuedCommandList
	)
...
func (a *CommandsApiService) GraphCommandAssociationsList(ctx context.Context, commandId string, targets []string, localVarOptionals map[string]interface{}) ([]GraphConnection,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param commandId ObjectID of the Command.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "body" (GraphOperationCommand) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return */
func (a *CommandsApiService) GraphCommandAssociationsPost(ctx context.Context, commandId string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(GraphOperationCommand); localVarOk {
...
func (a *CommandsApiService) GraphCommandTraverseSystem(ctx context.Context, commandId string, localVarOptionals map[string]interface{}) ([]GraphObjectWithPaths,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "filter" ([]string) A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
 @return []GraphObjectWithPaths*/
func (a *CommandsApiService) GraphCommandTraverseSystemGroup(ctx context.Context, commandId string, localVarOptionals map[string]interface{}) ([]GraphObjectWithPaths,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
