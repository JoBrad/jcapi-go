...
func (a *PolicytemplatesApiService) PolicytemplatesGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (PolicyTemplateWithDetails,  *http.Response, error) {
	var (
...
func (a *PolicytemplatesApiService) PolicytemplatesList(ctx context.Context, localVarOptionals map[string]interface{}) ([]PolicyTemplate,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
