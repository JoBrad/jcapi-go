...
func (a *CommandResultsApiService) CommandsListResultsByWorkflow(ctx context.Context, localVarOptionals map[string]interface{}) (CommandResultList,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  CommandResultList
	)
