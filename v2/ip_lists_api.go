 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return IpList*/
func (a *IPListsApiService) IplistsDelete(ctx context.Context, id string, localVarOptionals map[string]interface{}) (IpList,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  IpList
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return IpList*/
func (a *IPListsApiService) IplistsGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (IpList,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return []IpList*/
func (a *IPListsApiService) IplistsList(ctx context.Context, localVarOptionals map[string]interface{}) ([]IpList,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param id 
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "body" (IpListRequest) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return IpList*/
func (a *IPListsApiService) IplistsPatch(ctx context.Context, id string, localVarOptionals map[string]interface{}) (IpList,  *http.Response, error) {
	var (
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(IpListRequest); localVarOk {
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return IpList*/
func (a *IPListsApiService) IplistsPost(ctx context.Context, localVarOptionals map[string]interface{}) (IpList,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "body" (IpListRequest) 
 @return IpList*/
func (a *IPListsApiService) IplistsPut(ctx context.Context, id string, localVarOptionals map[string]interface{}) (IpList,  *http.Response, error) {
	var (
