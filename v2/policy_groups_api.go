...
func (a *PolicyGroupsApiService) GraphPolicyGroupAssociationsList(ctx context.Context, groupId string, targets []string, localVarOptionals map[string]interface{}) ([]GraphConnection,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param groupId ObjectID of the Policy Group.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "body" (GraphOperationPolicyGroup) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return */
func (a *PolicyGroupsApiService) GraphPolicyGroupAssociationsPost(ctx context.Context, groupId string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(GraphOperationPolicyGroup); localVarOk {
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return []GraphConnection*/
func (a *PolicyGroupsApiService) GraphPolicyGroupMembersList(ctx context.Context, groupId string, localVarOptionals map[string]interface{}) ([]GraphConnection,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param groupId ObjectID of the Policy Group.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "body" (GraphOperationPolicyGroupMember) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return */
func (a *PolicyGroupsApiService) GraphPolicyGroupMembersPost(ctx context.Context, groupId string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(GraphOperationPolicyGroupMember); localVarOk {
		localVarPostBody = &localVarTempParam
	}
	if ctx != nil {
		// API Key Authentication
...
func (a *PolicyGroupsApiService) GraphPolicyGroupMembership(ctx context.Context, groupId string, localVarOptionals map[string]interface{}) ([]GraphObjectWithPaths,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "filter" ([]string) A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
 @return []GraphObjectWithPaths*/
func (a *PolicyGroupsApiService) GraphPolicyGroupTraverseSystem(ctx context.Context, groupId string, localVarOptionals map[string]interface{}) ([]GraphObjectWithPaths,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "filter" ([]string) A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
 @return []GraphObjectWithPaths*/
func (a *PolicyGroupsApiService) GraphPolicyGroupTraverseSystemGroup(ctx context.Context, groupId string, localVarOptionals map[string]interface{}) ([]GraphObjectWithPaths,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return PolicyGroup*/
func (a *PolicyGroupsApiService) GroupsPolicyDelete(ctx context.Context, id string, localVarOptionals map[string]interface{}) (PolicyGroup,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  PolicyGroup
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return PolicyGroup*/
func (a *PolicyGroupsApiService) GroupsPolicyGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (PolicyGroup,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return []PolicyGroup*/
func (a *PolicyGroupsApiService) GroupsPolicyList(ctx context.Context, localVarOptionals map[string]interface{}) ([]PolicyGroup,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "body" (PolicyGroupData) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return PolicyGroup*/
func (a *PolicyGroupsApiService) GroupsPolicyPost(ctx context.Context, localVarOptionals map[string]interface{}) (PolicyGroup,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(PolicyGroupData); localVarOk {
		localVarPostBody = &localVarTempParam
	}
	if ctx != nil {
		// API Key Authentication
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return PolicyGroup*/
func (a *PolicyGroupsApiService) GroupsPolicyPut(ctx context.Context, id string, localVarOptionals map[string]interface{}) (PolicyGroup,  *http.Response, error) {
	var (
