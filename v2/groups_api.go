 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xUnfilteredTotalCount" (int32) If provided in the request with any non-empty value, this header will be returned on the response populated with the total count of objects without filters taken into account
 @return []Group*/
func (a *GroupsApiService) GroupsList(ctx context.Context, localVarOptionals map[string]interface{}) ([]Group,  *http.Response, error) {
	var (
	...
	if err := typeCheckParameter(localVarOptionals["xUnfilteredTotalCount"], "int32", "xUnfilteredTotalCount"); err != nil {
		return successPayload, nil, err
	}
	...
	if localVarTempParam, localVarOk := localVarOptionals["xUnfilteredTotalCount"].(int32); localVarOk {
		localVarHeaderParams["x-unfiltered-total-count"] = parameterToString(localVarTempParam, "")
	}
	if ctx != nil {
