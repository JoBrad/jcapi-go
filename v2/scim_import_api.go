...
func (a *SCIMImportApiService) ImportUsers(ctx context.Context, applicationId string, localVarOptionals map[string]interface{}) (ImportUsersResponse,  *http.Response, error) {
	var (
