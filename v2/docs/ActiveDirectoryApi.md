...
> ActiveDirectoryAgentList ActivedirectoriesAgentsGet(ctx, activedirectoryId, agentId, optional)
...
[**ActiveDirectoryAgentList**](active-directory-agent-list.md)
...
> []ActiveDirectoryAgentList ActivedirectoriesAgentsList(ctx, activedirectoryId, optional)
...
> ActiveDirectoryAgentGet ActivedirectoriesAgentsPost(ctx, activedirectoryId, optional)
...
------------- | ------------- | ------------- | -------------
 **activedirectoryId** | **string**|  | 
 **body** | [**ActiveDirectoryAgent**](ActiveDirectoryAgent.md)|  | 
 **xOrgId** | **string**| Organization identifier that can be obtained from console settings. | 

### Return type

[**ActiveDirectoryAgentGet**](active-directory-agent-get.md)
...
> ActiveDirectory ActivedirectoriesDelete(ctx, id, optional)
...
> ActiveDirectory ActivedirectoriesGet(ctx, id, optional)
...
> []ActiveDirectory ActivedirectoriesList(ctx, optional)
...
> ActiveDirectory ActivedirectoriesPost(ctx, optional)
