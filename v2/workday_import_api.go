 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
func (a *WorkdayImportApiService) WorkdaysAuthorize(ctx context.Context, workdayId string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return */
func (a *WorkdayImportApiService) WorkdaysDeauthorize(ctx context.Context, workdayId string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
...
func (a *WorkdayImportApiService) WorkdaysGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (WorkdayOutput,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return JobId*/
func (a *WorkdayImportApiService) WorkdaysImport(ctx context.Context, workdayId string, localVarOptionals map[string]interface{}) (JobId,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
...
func (a *WorkdayImportApiService) WorkdaysImportresults(ctx context.Context, id string, jobId string, localVarOptionals map[string]interface{}) ([]JobWorkresult,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return []WorkdayOutput*/
func (a *WorkdayImportApiService) WorkdaysList(ctx context.Context, localVarOptionals map[string]interface{}) ([]WorkdayOutput,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return WorkdayOutput*/
func (a *WorkdayImportApiService) WorkdaysPost(ctx context.Context, localVarOptionals map[string]interface{}) (WorkdayOutput,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return WorkdayOutput*/
func (a *WorkdayImportApiService) WorkdaysPut(ctx context.Context, id string, localVarOptionals map[string]interface{}) (WorkdayOutput,  *http.Response, error) {
	var (
...
func (a *WorkdayImportApiService) WorkdaysWorkers(ctx context.Context, workdayId string, localVarOptionals map[string]interface{}) ([]WorkdayWorker,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
