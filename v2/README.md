...
Directory Objects. The Graph is a powerful aspect of our platform which will enable you to associate objects with each other, or establish membership for certain objects to become members of other objects.
...
`https://console.jumpcloud.com/api/organizations/` This will return all your managed organizations.
...
By using the [swagger-spec](https://github.com/swagger-api/swagger-spec) from a remote server, you can easily generate an API client.
...
*AppleMDMApi* | [**ApplemdmsDevicesOSUpdateStatus**](docs/AppleMDMApi.md#applemdmsdevicesosupdatestatus) | **Post** /applemdms/{apple_mdm_id}/devices/{device_id}/osUpdateStatus | Request the status of an OS update for a device
...
*BulkJobRequestsApi* | [**BulkUserUnlocks**](docs/BulkJobRequestsApi.md#bulkuserunlocks) | **Post** /bulk/user/unlocks | Bulk Unlock Users
...
*GoogleEMMApi* | [**DevicesEraseDevice**](docs/GoogleEMMApi.md#deviceserasedevice) | **Post** /google-emm/devices/{deviceId}/erase-device | Erase the Android Device
...
*GraphApi* | [**GraphRadiusServerAssociationsList**](docs/GraphApi.md#graphradiusserverassociationslist) | **Get** /radiusservers/{radiusserver_id}/associations | List the associations of a RADIUS
...
*GraphApi* | [**GraphRadiusServerTraverseUser**](docs/GraphApi.md#graphradiusservertraverseuser) | **Get** /radiusservers/{radiusserver_id}/users | List the Users bound to a RADIUS

Server
*GraphApi* | [**GraphRadiusServerTraverseUserGroup**](docs/GraphApi.md#graphradiusservertraverseusergroup) | **Get** /radiusservers/{radiusserver_id}/usergroups | List the User Groups bound to a RADIUS
...
*Office365Api* | [**DomainsDelete**](docs/Office365Api.md#domainsdelete) | **Delete** /office365s/{resourceObjectId}/domains/{objectId} | Delete domain
*Office365Api* | [**DomainsInsert**](docs/Office365Api.md#domainsinsert) | **Post** /office365s/{resourceObjectId}/domains | Insert domain
*Office365Api* | [**DomainsList**](docs/Office365Api.md#domainslist) | **Get** /office365s/{resourceObjectId}/domains | List domains
...
*PasswordManagerApi* | [**DeviceServiceGetDevice**](docs/PasswordManagerApi.md#deviceservicegetdevice) | **Get** /passwordmanager/devices/{UUID} |
*PasswordManagerApi* | [**DeviceServiceListDevices**](docs/PasswordManagerApi.md#deviceservicelistdevices) | **Get** /passwordmanager/devices |
...
*RADIUSServersApi* | [**GraphRadiusServerAssociationsList**](docs/RADIUSServersApi.md#graphradiusserverassociationslist) | **Get** /radiusservers/{radiusserver_id}/associations | List the associations of a RADIUS
...
*RADIUSServersApi* | [**GraphRadiusServerTraverseUser**](docs/RADIUSServersApi.md#graphradiusservertraverseuser) | **Get** /radiusservers/{radiusserver_id}/users | List the Users bound to a RADIUS

Server
*RADIUSServersApi* | [**GraphRadiusServerTraverseUserGroup**](docs/RADIUSServersApi.md#graphradiusservertraverseusergroup) | **Get** /radiusservers/{radiusserver_id}/usergroups | List the User Groups bound to a RADIUS
...
## Documentation For Models
 ...
 - [CloudInsightsAccountListResponse](docs/CloudInsightsAccountListResponse.md)
 - [CloudInsightsAccountPost](docs/CloudInsightsAccountPost.md)
 - [CloudInsightsAccountPostResponse](docs/CloudInsightsAccountPostResponse.md)
 - [CloudInsightsAccountPut](docs/CloudInsightsAccountPut.md)
 - [CloudInsightsEventsDistinctPost](docs/CloudInsightsEventsDistinctPost.md)
 - [CloudInsightsEventsDistinctResponse](docs/CloudInsightsEventsDistinctResponse.md)
 - [CloudInsightsEventsListEventDetails](docs/CloudInsightsEventsListEventDetails.md)
 - [CloudInsightsEventsListEvents](docs/CloudInsightsEventsListEvents.md)
 - [CloudInsightsEventsListPost](docs/CloudInsightsEventsListPost.md)
 - [CloudInsightsEventsListResponse](docs/CloudInsightsEventsListResponse.md)
 - [CloudInsightsEventsSearchTerm](docs/CloudInsightsEventsSearchTerm.md)
 - [CloudInsightsSavedViewBase](docs/CloudInsightsSavedViewBase.md)
 - [CloudInsightsSavedViewId](docs/CloudInsightsSavedViewId.md)
 - [CloudInsightsTermConjunction](docs/CloudInsightsTermConjunction.md)
 - [CloudInsightsTermItem](docs/CloudInsightsTermItem.md)
 - [CloudinsightseventsdistinctpostEndTime](docs/CloudinsightseventsdistinctpostEndTime.md)
 - [CloudinsightseventslisteventdetailsAddendum](docs/CloudinsightseventslisteventdetailsAddendum.md)
 - [CloudinsightseventslisteventdetailsAdditionalEventData](docs/CloudinsightseventslisteventdetailsAdditionalEventData.md)
 - [CloudinsightseventslisteventdetailsEdgeDeviceDetails](docs/CloudinsightseventslisteventdetailsEdgeDeviceDetails.md)
 - [CloudinsightseventslisteventdetailsEventTime](docs/CloudinsightseventslisteventdetailsEventTime.md)
 - [CloudinsightseventslisteventdetailsRequestParameters](docs/CloudinsightseventslisteventdetailsRequestParameters.md)
 - [CloudinsightseventslisteventdetailsRequestParametersEncryptionContext](docs/CloudinsightseventslisteventdetailsRequestParametersEncryptionContext.md)
 - [CloudinsightseventslisteventdetailsRequestParametersIncludes](docs/CloudinsightseventslisteventdetailsRequestParametersIncludes.md)
 - [CloudinsightseventslisteventdetailsResources](docs/CloudinsightseventslisteventdetailsResources.md)
 - [CloudinsightseventslisteventdetailsResponseElements](docs/CloudinsightseventslisteventdetailsResponseElements.md)
 - [CloudinsightseventslisteventdetailsResponseElementsAssumedRoleUser](docs/CloudinsightseventslisteventdetailsResponseElementsAssumedRoleUser.md)
 - [CloudinsightseventslisteventdetailsResponseElementsCredentials](docs/CloudinsightseventslisteventdetailsResponseElementsCredentials.md)
 - [CloudinsightseventslisteventdetailsServiceEventDetails](docs/CloudinsightseventslisteventdetailsServiceEventDetails.md)
 - [CloudinsightseventslisteventdetailsTlsDetails](docs/CloudinsightseventslisteventdetailsTlsDetails.md)
 - [CloudinsightseventslisteventdetailsUserIdentity](docs/CloudinsightseventslisteventdetailsUserIdentity.md)
 - [CloudinsightseventslisteventdetailsUserIdentitySessionContext](docs/CloudinsightseventslisteventdetailsUserIdentitySessionContext.md)
 - [CloudinsightseventslisteventdetailsUserIdentitySessionContextAttributes](docs/CloudinsightseventslisteventdetailsUserIdentitySessionContextAttributes.md)
 - [CloudinsightseventslisteventdetailsUserIdentitySessionContextSessionIssuer](docs/CloudinsightseventslisteventdetailsUserIdentitySessionContextSessionIssuer.md)
 - [CloudinsightseventslisteventdetailsUserIdentitySessionContextWebIdFederationData](docs/CloudinsightseventslisteventdetailsUserIdentitySessionContextWebIdFederationData.md)
 - [CloudinsightseventslisteventdetailsUserIdentitySessionContextWebIdFederationDataAttributes](docs/CloudinsightseventslisteventdetailsUserIdentitySessionContextWebIdFederationDataAttributes.md)
 - [CloudinsightssavedviewbaseFilters](docs/CloudinsightssavedviewbaseFilters.md)
 - [CloudinsightstermitemTermArray](docs/CloudinsightstermitemTermArray.md)
 - [CloudinsightstermitemTermValue](docs/CloudinsightstermitemTermValue.md)
 ...
 - [InlineResponse20012Users](docs/InlineResponse20012Users.md)
 ...
 - [JumpcloudGoogleEmmCommandResponse](docs/JumpcloudGoogleEmmCommandResponse.md)
 ...
 - [PwmUserSharedFoldersResults](docs/PwmUserSharedFoldersResults.md)
 - [Query](docs/Query.md)
 ...
 - [SyncroMappingRequestBillingConfigurations](docs/SyncroMappingRequestBillingConfigurations.md)
 - [SyncroMappingRequestBillingConfigurationsFields](docs/SyncroMappingRequestBillingConfigurationsFields.md)
 - [SyncroMappingRequestBillingConfigurationsFieldsLineItemId](docs/SyncroMappingRequestBillingConfigurationsFieldsLineItemId.md)
 - [SyncroMappingRequestBillingConfigurationsFieldsLineItemName](docs/SyncroMappingRequestBillingConfigurationsFieldsLineItemName.md)
 - [SyncroMappingRequestData](docs/SyncroMappingRequestData.md)
 ...
 - [CloudInsightsSavedViewPost](docs/CloudInsightsSavedViewPost.md)
 - [CloudInsightsSavedViewPut](docs/CloudInsightsSavedViewPut.md)
 - [CloudInsightsSavedViewResponse](docs/CloudInsightsSavedViewResponse.md)
