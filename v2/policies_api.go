...
func (a *PoliciesApiService) GraphPolicyAssociationsList(ctx context.Context, policyId string, targets []string, localVarOptionals map[string]interface{}) ([]GraphConnection,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param policyId ObjectID of the Policy.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "body" (GraphOperationPolicy) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return */
func (a *PoliciesApiService) GraphPolicyAssociationsPost(ctx context.Context, policyId string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(GraphOperationPolicy); localVarOk {
...
func (a *PoliciesApiService) GraphPolicyMemberOf(ctx context.Context, policyId string, localVarOptionals map[string]interface{}) ([]GraphObjectWithPaths,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "filter" ([]string) A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
 @return []GraphObjectWithPaths*/
func (a *PoliciesApiService) GraphPolicyTraverseSystem(ctx context.Context, policyId string, localVarOptionals map[string]interface{}) ([]GraphObjectWithPaths,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "filter" ([]string) A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
 @return []GraphObjectWithPaths*/
func (a *PoliciesApiService) GraphPolicyTraverseSystemGroup(ctx context.Context, policyId string, localVarOptionals map[string]interface{}) ([]GraphObjectWithPaths,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return */
func (a *PoliciesApiService) PoliciesDelete(ctx context.Context, id string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
...
func (a *PoliciesApiService) PoliciesGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (PolicyWithDetails,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return []Policy*/
func (a *PoliciesApiService) PoliciesList(ctx context.Context, localVarOptionals map[string]interface{}) ([]Policy,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return PolicyWithDetails*/
func (a *PoliciesApiService) PoliciesPost(ctx context.Context, localVarOptionals map[string]interface{}) (PolicyWithDetails,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return PolicyResult*/
func (a *PoliciesApiService) PolicyresultsGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (PolicyResult,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "sort" ([]string) The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
 @return []PolicyResult*/
func (a *PoliciesApiService) PolicyresultsList(ctx context.Context, policyId string, localVarOptionals map[string]interface{}) ([]PolicyResult,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "sort" ([]string) The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
 @return []PolicyResult*/
func (a *PoliciesApiService) PolicyresultsOrgList(ctx context.Context, localVarOptionals map[string]interface{}) ([]PolicyResult,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return []PolicyResult*/
func (a *PoliciesApiService) PolicystatusesPoliciesList(ctx context.Context, policyId string, localVarOptionals map[string]interface{}) ([]PolicyResult,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return []PolicyResult*/
func (a *PoliciesApiService) PolicystatusesSystemsList(ctx context.Context, systemId string, localVarOptionals map[string]interface{}) ([]PolicyResult,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
func (a *PoliciesApiService) PolicytemplatesGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (PolicyTemplateWithDetails,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
func (a *PoliciesApiService) PolicytemplatesList(ctx context.Context, localVarOptionals map[string]interface{}) ([]PolicyTemplate,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
