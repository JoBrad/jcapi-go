 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
func (a *ApplicationsApiService) ApplicationsDeleteLogo(ctx context.Context, applicationId string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return interface{}*/
func (a *ApplicationsApiService) ApplicationsGet(ctx context.Context, applicationId string, localVarOptionals map[string]interface{}) (interface{},  *http.Response, error) {
	var (
...
/* ApplicationsApiService Save application logo
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return */
func (a *ApplicationsApiService) ApplicationsPostLogo(ctx context.Context, applicationId string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
...
func (a *ApplicationsApiService) GraphApplicationAssociationsList(ctx context.Context, applicationId string, targets []string, localVarOptionals map[string]interface{}) ([]GraphConnection,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param applicationId ObjectID of the Application.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "body" (GraphOperationApplication) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return */
func (a *ApplicationsApiService) GraphApplicationAssociationsPost(ctx context.Context, applicationId string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(GraphOperationApplication); localVarOk {
...
func (a *ApplicationsApiService) GraphApplicationTraverseUser(ctx context.Context, applicationId string, localVarOptionals map[string]interface{}) ([]GraphObjectWithPaths,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "filter" ([]string) A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
 @return []GraphObjectWithPaths*/
func (a *ApplicationsApiService) GraphApplicationTraverseUserGroup(ctx context.Context, applicationId string, localVarOptionals map[string]interface{}) ([]GraphObjectWithPaths,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
/* ApplicationsApiService Create an import job
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param applicationId ObjectID of the Application.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "body" (ImportUsersRequest) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
 @return JobId*/
func (a *ApplicationsApiService) ImportCreate(ctx context.Context, applicationId string, localVarOptionals map[string]interface{}) (JobId,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/applications/{application_id}/import/jobs"
	localVarPath = strings.Replace(localVarPath, "{"+"application_id"+"}", fmt.Sprintf("%v", applicationId), -1)
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(ImportUsersRequest); localVarOk {
		localVarPostBody = &localVarTempParam
	}
	if ctx != nil {
		// API Key Authentication
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param applicationId ObjectID of the Application.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "filter" (string) Filter users by a search term
     @param "query" (string) URL query to merge with the service provider request
     @param "sort" (string) Sort users by supported fields
     @param "sortOrder" (string) 
     @param "xOrgId" (string) Organization identifier that can be obtained from console settings.
     @param "limit" (int32) The number of records to return at once. Limited to 100.
     @param "skip" (int32) The offset into the records to return.
 @return ImportUsersResponse*/
func (a *ApplicationsApiService) ImportUsers(ctx context.Context, applicationId string, localVarOptionals map[string]interface{}) (ImportUsersResponse,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  ImportUsersResponse
	)
