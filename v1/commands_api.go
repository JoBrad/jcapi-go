...
func (a *CommandsApiService) CommandsGetResults(ctx context.Context, id string, localVarOptionals map[string]interface{}) ([]Commandresult,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
/* CommandsApiService Run a command
...
func (a *CommandsApiService) CommandsRun(ctx context.Context, localVarOptionals map[string]interface{}) (InlineResponse200,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/runCommand"
