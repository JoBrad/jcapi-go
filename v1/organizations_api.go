 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "sortIgnoreCase" (string) Use space separated sort parameters to sort the collection, ignoring case. Default sort is ascending. Prefix with &#x60;-&#x60; to sort descending. 
...
func (a *OrganizationsApiService) OrganizationList(ctx context.Context, localVarOptionals map[string]interface{}) (Organizationslist,  *http.Response, error) {
	...
	if err := typeCheckParameter(localVarOptionals["sortIgnoreCase"], "string", "sortIgnoreCase"); err != nil {
		return successPayload, nil, err
	}
	...
	if localVarTempParam, localVarOk := localVarOptionals["sortIgnoreCase"].(string); localVarOk {
		localVarQueryParams.Add("sortIgnoreCase", parameterToString(localVarTempParam, ""))
	}
